...
4. Web 表单
   ...
   2. （可以留到后面）信用卡信息
   3. 表单中的”regForm“改成其他名字
   4.  每一页的 "登录" 字体可链接登录页面
       1.  (稍后)注册
   5.  数据库：用Cpanel而不是mysql
       1.  自己练习：上网查保险单database模板
   6.  （晚点做应该可以）优化input人性化：如日期
...
（不重要的问题：）
   1.  访加客户保险-166行 是什么: "<input id="radioDefault_5" name="Field5" type="hidden" value="">"
   2.  在加居民出境-179行 是什么："<input id="radioDefault_5" name="Field5" type="hidden" value="">”
